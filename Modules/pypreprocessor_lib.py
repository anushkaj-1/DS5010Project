...
# Excel Data Preprocessing
    ...
    def _scale_data(self, data, method='minmax'):
        """
        ...
        try:
            ...
            # Creating a new DataFrame with scaled numeric columns
            scaled_df = pd.DataFrame(scaled_data, columns=numeric_cols, index=data.index)
            # Replacing original numeric columns with scaled ones
    ...
    def _handle_missing_values(self, data, strategy='mean'):
        ...
        try:
            ...
            imputed_data = pd.DataFrame(imputed_data, columns=numeric_cols, index=data.index)
            # Replacing original numeric columns with scaled ones
            for col in numeric_cols:
